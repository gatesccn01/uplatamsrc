                            ...
                            .addOnCompleteListener(SignInActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Log.d(TAG, "iniciar sesión con correo electrónico: éxito");
                                        ...
                                        if (user != null) {
                                            if (user.isEmailVerified()) {
                                                ...
                                                System.out.println("Correo Electrónico Verificado : " + user.isEmailVerified());
                                                Intent HomeActivity = new Intent(SignInActivity.this, ElMandarinDEv.class);
                                                ...
                                                errorView.setText("Verifique su ID de correo electrónico e inicie sesión");
                                        ...
                                        Log.w(TAG, "iniciar sesión con correo electrónico: error", task.getException());
